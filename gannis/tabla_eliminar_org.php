...
$query = "DELETE FROM organizaciones WHERE id = '$id'"; //consulta que elimina la fila de mascotas cuyo ID coincida con el que se obtuvo
...
header("Location: listados.php"); //se redirige a pestaña de listados
